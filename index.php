          ...
          <div class="content">
            ...
            switch($page) {
                case 'about':
                    ...
                    echo '<div class="answer">The guy from Bacon Ipsum, the guy from Tuna Ipsum, WordPress, Kazimir Malevich and Marcel Duchamp made this all happen. Y-a-v-a and ax710 did some coding and the graphics, except for the theme which loosely inspired by the Twenty-Ten from WordPress.</div>';
